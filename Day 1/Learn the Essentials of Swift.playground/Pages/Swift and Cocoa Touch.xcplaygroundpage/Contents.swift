...
let blueSquare = UIView(frame: CGRect(x: 0, y: 0, width: 100, height: 100))
blueSquare.backgroundColor = UIColor.blueColor()

let yellowTriangle = UIView(frame: CGRect(x: 0, y: 3, width: 120, height: 229))
yellowTriangle.backgroundColor = UIColor.yellowColor()
// I apparently don't know how to make triangles.
